...
MariaDB (MySQL). It is a sample site built for as a final project for a fictious
donut shop called Downtown Donuts. Please read the following instructions carefully
